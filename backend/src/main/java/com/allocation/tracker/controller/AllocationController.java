...
public class AllocationController {
    ...
    @PostMapping
    public ResponseEntity<?> createAllocation(@RequestBody UserProjectAllocation allocation) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateAllocation(@PathVariable Long id, @RequestBody UserProjectAllocation allocation) {
        try {
